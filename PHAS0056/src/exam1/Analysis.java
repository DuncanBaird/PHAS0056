...
public class Analysis {
	...
	public static void analysis(String URL) throws Exception {
		...
		System.out.println("The player with the maximum number of rushing yards " + "is:"
				+ players.get(playerMaxRushingYardsUUID));
		...
		for (String team : teams.keySet()) { // loops over teams
			...
			System.out.println(
					"The player with the highest liability for " + team + " is: " + largestLiability.get(team).get(0));
		}
		...
		for (String team : tenPlusTouches.keySet()) {
			...
			System.out.println(
					"The player with the highest butter finger for " + team + " is: " + largestButter.get(team).get(0));
					}
	}
